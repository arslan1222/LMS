...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-sm md:text-base text-gray-500 mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, quidem autem quod animi fugiat porro omnis suscipit voluptas fuga molestias.</p>
