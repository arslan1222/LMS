...
const CourseDetails = () => {
  ...
  const  { allCourses, calculateRating, calculateChapterTime, calculateLectures, calculateCourseDuration, currency } = useContext(AppContext);
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-course-details-heading-large text-course-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>How I Grow</span></p>
