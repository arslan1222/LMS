        ...
        <div className="flex flex-wrap gap-5 items-center">
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            ...
            <div>
              ...
              <p className="tet-base text-gray-600">Total Enrolments</p>
            </div>
          </div>
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            ...
            <div>
              ...
              <p className="tet-base text-gray-600">Total Courses</p>
            </div>
          </div>
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            ...
            <div>
              ...
              <p className="tet-base text-gray-600">Total Earnings</p>
            </div>
          </div>
        </div>
