...
const StudentsEnrolled = () => {
  ...
  return enrolledStudents ? (
    <div className='min-h-screen flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt--8 pb-0'>
      <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-b border-fray-500/30'>
        <table className='table-fixed md:table-auto w-full overflow-hidden pb-4'>
          <thead className='text-gray-900 border-b border-gray-500/30 text-sm text-left'>
            <tr>
              <th className='px- py-3 font-semibold text-center hidden sm:table-cell text-primary2'>#</th>
              ...
              <th className='px-4 py-3 font-semibold hidden md:table-cell text-primary2'>Date</th>
            </tr>
          </thead>
          <tbody className='text-sm text-gray-500'>

            {
              enrolledStudents.map((item, index)=>(
                <tr key={index} className='border-b border-gray-500/20 hover:bg-primaryHover'>
